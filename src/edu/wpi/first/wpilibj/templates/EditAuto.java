...
public class EditAuto {
    ...
    private boolean[] m_bShootUp = new boolean[m_iArraySize];
    private boolean[] m_bUnderGlow = new boolean[m_iArraySize];
    ...
    public String printFile(String sFileName)
    {
        ...
        {	
            ...
            System.out.println((m_bShootUp[index] = m_fileReader.readBoolean()) + "-");
            System.out.println((m_bUnderGlow[index] = m_fileReader.readBoolean()) + "-");
    ...
    public String modify(double dMin, double dMax, double dMtLeft, double dMtRight)
    {
        ...
        for(int index = 0; index < m_iArrayLength; index++)
        {
            ...
            m_fileWriter.writeData(m_dTimer[index], m_dMtLeft[index], m_dMtRight[index], m_bShootUp[index], m_bUnderGlow[index]);
        }
