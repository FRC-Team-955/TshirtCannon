...
class CJoyEmulator{
    ...
    private boolean m_bCannonStatus = false;
    private boolean m_bUnderGlowStatus = false;
    
    public  void add(double dTimer, double dMtLeft, double dMtRight, boolean bCannonStat, boolean bUnderGlowStat)
    {
        m_dTimer = dTimer;
        m_dMtLeft = dMtLeft;
        m_dMtRight = dMtRight;
        m_bCannonStatus = bCannonStat;
        m_bUnderGlowStatus = bUnderGlowStat;
    }
    ...
    public boolean getCannonStatus()
    {
        return m_bCannonStatus;
    }
    
    public boolean getUnderGlowStatus()
    {
        return m_bUnderGlowStatus;
    }
}
